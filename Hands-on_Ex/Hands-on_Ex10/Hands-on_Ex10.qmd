...
# Install the version that still has react_sparkline
...
The work below applies only to Windows and it is not Mac-compatible. I would have to use:

1.  brew install mdbtools and load each of them per table and join them.

2.  mdb-export "data/Coffee Chain.mdb" factTable \> data/factTable.csv mdb-export "data/Coffee Chain.mdb" Location \> data/Location.csv mdb-export "data/Coffee Chain.mdb" Product \> data/Product.csv
