...
I resized the graph to be larger by adjusting the bscols(widths = c(7,4) so that the header does not get cut off. Besides, it provides better clarity.
:::
...
## 4.4 Visualizing the uncertainty of point estimates: ggdist methods (cont.)
...
# uncomment and run this once only.
```
