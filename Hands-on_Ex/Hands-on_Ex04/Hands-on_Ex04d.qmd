...
Check the number of distinct values in City, District, and Sub-district columns.
...
The code chunk below plots a funnel plot. I resized the figures so the "control limits" would not get cut off.
...
-   By default, `data_type`argument is Standardised Ratio (SR)
...
In this section, I will gain hands-on experience on building funnel plots step-by-step by using ggplot2. It aims to enhance my working experience of ggplot2 to customise specialised data visualisation like funnel plot.
...
## 4.4 Interactive Funnel Plot: plotly + gglplot2
